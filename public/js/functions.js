    ...
    function init_popup(){
        if($(window).width() + boutique_get_scrollbar_width() >= 768){
            if($('body').hasClass('home')){
                ...
                $.magnificPopup.open({
                  items: {
                    src: '<div class="white-popup"><div class="kt-popup-newsletter"><div class="popup-title"><h3>Joyería Quisuruco</h3><img src="images/arow-popup.png" alt=""><p class="notice">Deja tu correo y obtén hasta  <span class="primary">20% Dscto</span> En tu primera compra!</p></div><form class="form-subscribe"><input class="input" placeholder="Ingresa tu correo" type="text" /><button class="button">No quiero la oferta</button><button class="button">INGRESAR</button></form><div class="checkbox"><label><input type="checkbox" value="">No volver a mostrar esta oferta</label></div></div></div>',  //can be a HTML string, jQuery object, or CSS selector
                    type: 'inline'
                  }
                });
            }
